  ...
  return (
    <div className="about">
      <div className="about__container">
        <img className="about__container__img" src="/assets/profilPic.png" alt="me,myself and I" />
        <div className="about__container__text" >
          <h1 className="about__container__text__h1">About me</h1>
          <p className="about__container__text__p">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente omnis voluptates, ducimus expedita consectetur assumenda sed laudantium cum sunt repellendus dicta explicabo dolores ea incidunt, vel accusamus? Repudiandae, sed blanditiis.</p>
